...
import { SOCIAL_PRIMARY } from '@/constants/socials'

const SIZE = 'h-12 w-12 sm:h-14 sm:w-14'
const iconWrap = `flex ${SIZE} items-center justify-center shadow-[0_10px_28px_-12px_rgba(0,0,0,0.45)] transition-colors`
...
const fabColors: Record<string, string> = {
  ...
  x: 'bg-[#111111] text-white',
  email: 'bg-[var(--brand)] text-wiz_ink',
  resume: 'bg-wiz_peach text-wiz_ink',
}
    ...
    <div className='fixed bottom-4 right-4 sm:bottom-8 sm:right-8 z-[1000] flex flex-col items-end'>
      <div className='relative flex flex-col items-center'>
        ...
        <button
          ...
          title='Back to top'
          className={`${iconWrap} mb-2.5 bg-wiz_ink text-white`}>
        ...
        <button
          ...
          className={`${iconWrap} mb-2.5 bg-white text-wiz_ink border-2 border-wiz_ink ${
            open ? 'rotate-45' : ''
        ...
        {whatsapp && (
          <a
            ...
            title='WhatsApp'
            className={`${iconWrap} bg-[#25D366] text-white`}>
            {icons.whatsapp}
          </a>
        )}
      </div>
