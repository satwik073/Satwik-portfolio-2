      ...
      <div className='container pt-8 sm:pt-10 lg:pt-12 pb-6 sm:pb-8'>
        ...
        <div className='mt-6 sm:mt-8 grid grid-cols-2 Xsm:grid-cols-3 lg:grid-cols-6 gap-5 sm:gap-6 lg:gap-8'>
          <div className='col-span-2 Xsm:col-span-3 lg:col-span-1 max-w-xs'>
            <p className='text-[13.5px] sm:text-[14px] leading-[1.55] text-white/70'>
                  ...
                  return (
                    <li key={li}>
                      <Link
                        ...
                        className='text-[13px] text-white/70 hover:text-white inline-flex items-center py-1'>
                        {l.name}
                      </Link>
                    </li>
                  )
        ...
        <div className='mt-8 sm:mt-10 border-t border-white/10 pt-6 flex flex-col lg:flex-row gap-5 justify-between items-start lg:items-center'>
          <div className='flex flex-col gap-2.5'>
            ...
            <div className='flex flex-wrap items-center gap-x-4 gap-y-2'>
              <Link
                ...
                className='inline-flex items-center gap-2 text-[13.5px] text-white/70 hover:text-white py-1'>
                WhatsApp
              </Link>
              <Link
          ...
          <Link
            href='/contact'
            className='inline-flex items-center gap-2 border border-white text-white text-[13.5px] font-medium px-4 py-2.5 hover:bg-white hover:text-wiz_ink transition'>
            Get In Touch
          </Link>
        </div>

        <div className='mt-6 flex flex-col lg:flex-row justify-between gap-2 text-[12.5px] text-white/70'>
