...
const stats = [
  ...
  },
  {
    brand: 'Performance',
    metric: '65%',
    label: 'Faster Page Loads via CDN',
    href: '/#work',
  },
  {
    brand: 'PIM Platform',
    metric: '100K+',
    label: 'SKUs in Product Detail UX',
    href: '/#work',
  },
]
        ...
        <div className='grid lg:grid-cols-12 gap-6 sm:gap-10 items-center'>
          ...
          <div className='lg:col-span-7'>
            <h2 className='wiz-display text-[26px] sm:text-[36px] md:text-[44px] lg:text-[54px] text-wiz_ink dark:text-white'>
              Full-stack Software Development Engineer with 2+ years shipping
              Java / Spring Boot / Hibernate backends and React / Next.js
              frontends — Ag-Grid SSRM, REST APIs, and products for 120+ clients.
            </h2>
            <div className='mt-8 flex items-center gap-4 wiz-eyebrow flex-wrap'>
              <span>Chandigarh / Gurugram</span>
              <span className='inline-block w-px h-3 bg-wiz_ink/30' />
              <span>B.Tech CSE · 9.41 CGPA</span>
              <span className='inline-block w-px h-3 bg-wiz_ink/30' />
            ...
            <div className='mt-6 flex flex-wrap gap-3'>
              ...
              <Link
                ...
                className='inline-flex items-center gap-2 border border-wiz_ink/20 text-wiz_ink dark:text-white dark:border-white/25 text-[13px] tracking-[0.16em] uppercase font-medium px-6 py-3.5 hover:bg-wiz_chip/40 transition-colors'>
                Email
              </Link>
            </div>
          </div>
            ...
            <Link
              ...
              <div className='flex items-end justify-between gap-4'>
                <div>
                  ...
                  <p className='wiz-eyebrow text-wiz_ink dark:text-white/80 mt-3 max-w-[16ch]'>
                    {s.label}
                  </p>
                </div>
