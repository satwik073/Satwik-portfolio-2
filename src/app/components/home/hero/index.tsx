          ...
          <div className='flex flex-col gap-8'>
            ...
            <div className='relative flex flex-col text-center items-center '>
              <h1 className="leading-none">
                <TextGenerateEffect className='text-3xl md:text-6xl lg:text-8xl leading-none' words="I build systems that" />
                <TextGenerateEffect
                  words="scale to millions."
                  delay={0.8}
                  className="italic font-normal instrument-font text-3xl md:text-6xl lg:text-8xl leading-none md:-mt-1 block"
                />
              </h1>
              <p className='max-w-2xl text-dark_black/60 dark:text-white/60 mt-6 text-lg'>
                Satwik Kanhere &mdash; Software Development Engineer at WizCommerce.
                I architect and ship production-grade enterprise systems handling
                10K+ SKUs daily for 85+ US clients with 99.8% uptime.
                Full-stack engineer. Published researcher. Problem solver.
              </p>
            </div>
              ...
              <div className='flex flex-col items-center justify-center gap-8 w-full sm:flex-row'>
                ...
                <div className='flex gap-3'>
                  ...
                  <Link
                    ...
                    target='_blank'
                    className='group bg-transparent text-dark_black dark:text-white font-medium flex flex-row justify-center items-center py-2 px-5 rounded-full md:py-3 border border-dark_black/20 dark:border-white/20 transition-all duration-200 ease-in-out hover:border-dark_black dark:hover:border-white'>
                    <span className='flex transform transition-transform duration-200 text-center ease-in-out'>
                      View GitHub
                    </span>
                  </Link>
